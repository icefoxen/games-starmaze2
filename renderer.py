...
class RenderManager(object):
	...
	def add(s, renderer, rendercomponent):
		s.renderers[renderer].add(rendercomponent)
		
	def remove(s, renderer, rendercomponent):
		s.renderers[renderer].remove(rendercomponent)
